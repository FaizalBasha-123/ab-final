      ...
      <div className="relative bg-cover bg-center min-h-[340px] flex flex-col justify-center items-center" style={{backgroundImage: 'url(https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1200&q=80)'}}>
        ...
        <div className="relative z-10 max-w-4xl mx-auto py-16 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-8 mt-8">
            <div data-intro className="flex flex-col items-center animate-fade-in-up delay-100">
            ...
            <div data-intro className="flex flex-col items-center animate-fade-in-up delay-200">
            ...
            <div data-intro className="flex flex-col items-center animate-fade-in-up delay-300">
      ...
      <div className="bg-[#f8fafc] py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div data-intro className="bg-white rounded-xl p-6 shadow-sm animate-fade-in-up delay-100">
            ...
            <div data-intro className="bg-white rounded-xl p-6 shadow-sm animate-fade-in-up delay-200">
            ...
            <div data-intro className="bg-white rounded-xl p-6 shadow-sm animate-fade-in-up delay-300">
