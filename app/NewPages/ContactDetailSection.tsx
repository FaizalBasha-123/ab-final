  ...
  return (
    <main className="bg-[#f5f7fa] min-h-screen">
      ...
      <section className="py-10 max-w-3xl mx-auto">
        <div className="bg-[#f5f7fa] p-8 rounded-2xl shadow-lg border border-gray/300">
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="bg-[#23306a] rounded-2xl p-8 shadow flex flex-col items-center">
            ...
            <div className="flex flex-col md:flex-row gap-4 w-full justify-center">
              <Link href="tel:+91-8883678909" className="bg-white text-[#202b5e] px-6 py-3 rounded-lg font-avenir font-bold hover:bg-[#e6f0fa] transition w-full md:w-auto">Call Now: +91 8883678909</Link>
            </div>
