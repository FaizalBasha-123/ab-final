      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl font-freight font-book text-gray-600 max-w-3xl mx-auto">
            ...
            Let’s build systems that scale. Reach out today to discuss your challenges, explore solutions, and see how AB Lincoln & Company can help you unlock structured growth.
          </p>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="font-freight font-book text-gray-600">5D/179, Kirubai Nagar, <br/>CSI Kirubai Nathar Church,<br />Thoothukudi - 628008,<br />Tamil Nadu, India.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-lg font-avenir font-medium text-gray-900 mb-2">Email Address</h4>
            ...
            <form id="contact-form" onSubmit={handleSubmit}>
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  />
                  <p className='block text-sm font-avenir font-small text-gray-700 mt-2'>Should not add any Special Character</p>
                </div>
                <div>
