...
export default function HeroSection() {
  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-dvh flex items-center">
        <div className="w-full grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8" data-intro>
            <h1 data-intro className="text-4xl lg:text-5xl font-avenir font-bold text-gray-900 leading-tight">
            ...
            <div data-intro className="grid grid-cols-3 gap-3 pt-8 w-full max-w-full">
              <Card data-intro className="p-3 sm:p-6 text-center border-blue-100 hover:shadow-lg transition-all duration-300 bg-white/80 backdrop-blur-sm hover:scale-105 group animate-fade-in-up delay-100">
              ...
              <Card data-intro className="p-3 sm:p-6 text-center border-blue-100 hover:shadow-lg transition-all duration-300 bg-white/80 backdrop-blur-sm hover:scale-105 group animate-fade-in-up delay-200">
              ...
              <Card data-intro className="p-3 sm:p-6 text-center border-blue-100 hover:shadow-lg transition-all duration-300 bg-white/80 backdrop-blur-sm hover:scale-105 group animate-fade-in-up delay-300">
          ...
          <div data-intro className="hidden lg:flex justify-center animate-fade-in-left delay-300">
              <img 
